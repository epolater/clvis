...
def usage():
    # Print usage
    print(textstyle.yellow + "\nUsage for image: clvis.py img 'filename' 'characterset(from 0 to 5)' 'size in pixel(X,Y)'")
    print("Usage for video: clvis vid 'filename' 'characterset(from 0 to 5)' 'sizes in pixel(X,Y)' 'framerate'")
    print(textstyle.green + "Usage for video: clvis vid video.mp4 2 40,70 30'\n" + textstyle.default)
    sys.exit()
